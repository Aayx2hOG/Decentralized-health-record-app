...
export function pubkeyBase58ToDidKey(base58Pub: string): string {
    const pub = bs58.decode(base58Pub);
    return ed25519PubkeyToDidKey(pub);
}

export function didKeyToEd25519Pubkey(didKey: string): Uint8Array {
