      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {!wallet.publicKey && (
          <Alert>
            ...
            <AlertDescription>Please connect your wallet to manage admins</AlertDescription>
          </Alert>
        )}
          ...
          <CardContent>
            <div className="flex gap-3">
              ...
              <div className="flex items-end">
                <Button onClick={addAdmin} disabled={loading || !wallet.publicKey || !newAdmin} className="gap-2">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>List of users with admin access to the dashboard</CardDescription>
              </div>
                    ...
                    <div className="flex items-center justify-between gap-4 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Added: {new Date(admin.addedAt).toLocaleDateString()} at{' '}
                          {new Date(admin.addedAt).toLocaleTimeString()}
                        </p>
                      </div>
                      <Button
                        variant="destructive"
